    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('button_aria_label', models.CharField(default='Show or hide Top Level Navigation', help_text='Description for navigation button aria label', max_length=100)),
                ('button_text', models.CharField(default='Menu', max_length=100)),
                ('navigation_aria_label', models.CharField(default='Top Level Navigation', help_text='Description for navigation aria label', max_length=100)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='menu_items', to='navigation.MainMenu')),
