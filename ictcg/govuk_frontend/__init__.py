...
def register_inset_text_feature(features):
    """
    Registering the `inset-text` feature, which is stored as HTML with a `<div class="govuk-inset-text">` tag.
    """
    feature_name = 'inset-text'
    type_ = 'inset-text'
